...
UUID=${UUID:-'065a1c7a-6db4-4700-a228-51146831aad1'}
VMESS_WSPATH=${VMESS_WSPATH:-'/065a1c7a-6db4-4700-a228-51146831aad1-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/065a1c7a-6db4-4700-a228-51146831aad1-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/065a1c7a-6db4-4700-a228-51146831aad1-trojan'}
SS_WSPATH=${SS_WSPATH:-'/065a1c7a-6db4-4700-a228-51146831aad1-shadowsocks'}
